        ...
        <div className="blue_div">
            {
                    ...
                    <form onSubmit={handleSubmit} onReset={hendlReset}>
                      ...
                      <div className="flex max-[380px]:flex-col max-[380px]:gap-2 max-lg:gap-6 items-center justify-between mt-10 max-2xl:mt-5 max-lg:mt-4 max-md:mt-3 max-sm:mt-2">
                        ...
                        <div className="flex items-center gap-5 max-lg:hidden">
                          <img className="w-10 h-10" src="/icons/time.svg" alt="" />
                ...
                (
                    <div className="flex flex-col gap-5 items-center justify-center">
                          <h1 className="text-white text-center text-2xl font-medium">The end</h1>
                          <div>
                            {
                               Ansvers_list.map((item:any)=>(
                                    <div key={item.number}  className="flex items-center text-white">
                                        <p>{item.number}</p>
                                        :
                                        <p>{item.ansver ? "+" : "-"}</p>
                                    </div>
                          ...
                          <Link href={"/"}>
                            <button title="result" className="bg-white font-semibold cursor-pointer px-5 py-2 text-center rounded-xl">Go to back</button>
                          </Link>
                    </div>
                )
            }
