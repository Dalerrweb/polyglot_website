const ru = {
    ...
    info: {
        ...
        text1: "Методика разработана зарубежными университетами и соответствует международным стандартам образования, согласно которым вы сможете за короткое время овладеть любым языком вплоть до среднего уровня",
        ...
        text5: "Сейчас наши студенты учатся в топовых университетах мира ,в США, Англии, Германии и других развитых . Кроме того, 90% наших студентов успешно сдали экзамен IELTS и получили желаемые баллы.",
        ...
        text8: "Также родители информируются об успеваемости своих детей посредством регулярных звонков и СМС. ки.",
    },
    teacher: {
        title1: "",
