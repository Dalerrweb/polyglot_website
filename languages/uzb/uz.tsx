const uz = {
        ...
        courses:[
            {
                name1: "English",
                name2: "Kids",
                info: "Oksford tomonidan ishlab chiqilgan metodologiya tufayli bu bolalarni ingliz tilini o'rganishga uyg'otish uchun eng yaxshi kursdir. Darslar haftasiga 3 marta 2 soatdan o'tkaziladi. Noutbuklar va kitoblar ham bepul beriladi. Bolalar guruhlarida yosh 6 yoshdan 10 yoshgacha. Guruhga 2 ta o'qituvchi ajratilgan, 1-chi asosiysi - haftasiga 3 marta 2 soatdan, 2-si qo'shimcha - sinfdan tashqari.",
    ...
    info: {
        ...
        text2: "Bizning sinflarimiz qulay oqish uchun barcha zarur jihozlar bilan jihozlangan. Mustaqil ta'lim olish uchun alohida 'Coworking' maydoni ham mavjud.",
