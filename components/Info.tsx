   ...
   return (
      <div className="bg-blue">
         <div className="custom-container py-20 relative">
            <div className="w-2 max-xl:w-2 max-md:w-1 absolute top-32 max-lg:top-24 left-8 max-2xl:left-[46px] max-xl:left-[22px] max-lg:left-2 max-md:left-[13px] max-sm:left-[27px] min-h-[990px] max-3xl:min-h-[970px] max-2xl:min-h-[590px] max-xl:min-h-[420px] max-lg:min-h-[395px] max-md:min-h-[720px] max-sm:min-h-[850px] bg-white"></div>

            <div className="flex justify-between">
               <div className="relative max-w-[380px] max-2xl:max-w-[300px] max-lg:max-w-[200px] max-sm:max-w-[50px] w-full">
                  ...
                  <div className="w-8 h-8 max-xl:w-5 max-xl:h-5 max-lg:w-4 max-lg:h-4 absolute top-10 max-lg:top-3 -left-16 max-2xl:-left-10 max-xl:-left-7 max-lg:-left-5 max-md:-left-[24.7px] max-sm:-left-2 rounded-full bg-orange"></div>
               </div>
               <div className="max-sm:max-w-[400px] w-full flex max-md:flex-col justify-center items-center gap-1">
                  ...
                  <div className="max-w-[548px] w-full h-full max-md:min-h-[200px] rounded-2xl bg-[gray]"></div>
               </div>
            </div>
