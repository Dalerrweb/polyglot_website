    ...
    return (
        <div className="bg-blue">
            <div className="custom-container py-20 relative">
                <div className="w-2 max-xl:w-2 max-md:w-1 absolute top-32 max-lg:top-24 left-8 max-2xl:left-[5px] max-xl:left-[22px] max-lg:left-2 max-md:left-[13px] max-sm:left-[27px] min-h-[990px] max-3xl:min-h-[900px] max-2xl:min-h-[650px] max-xl:min-h-[460px] max-lg:min-h-[470px] max-md:min-h-[650px] max-sm:min-h-[900px] bg-white"></div>
