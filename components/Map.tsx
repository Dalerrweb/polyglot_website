            ...
            <div className="flex gap-2 max-sm:flex-col items-center max-sm:items-start justify-between">
               ...
               <div className="flex gap-3">
                  <button
                     ...
                     className="flex gap-1 items-center text-[32px] max-lg:text-[24px] font-medium leading-[30px] py-3 max-lg:py-2 px-6 max-lg:px-3 rounded-md bg-white"
                  >
                     <svg
                  ...
                  <button
                     ...
                     className="flex gap-1 items-center text-[32px] max-lg:text-[24px] font-medium leading-[30px] py-3 max-lg:py-2 px-6 max-lg:px-3 rounded-md bg-white"
                  >
                     <FaMapMarkerAlt size={40} color="#FF4433" /> Яндекс
                  </button>
               </div>
            </div>
            <div className="flex max-lg:flex-col gap-28 max-2xl:gap-10 max-xl:gap-5 mt-12">
               <div className="max-w-[350px] max-xl:max-w-[250px] w-full flex flex-col justify-between">
                  <div className="">
                     <p className="text-[40px] max-xl:text-[32px] font-bold leading-[40px] text-white">
                        Филиалы
                     </p>
                     <ul className="mt-4">
                        <li className="text-[32px] max-xl:text-[24px] leading-[40px] max-xl:leading-[30px] cursor-pointer mb-1 text-white">
                           Основная школа
                        </li>
                        <li className="text-[32px] max-xl:text-[24px] leading-[40px] max-xl:leading-[30px] cursor-pointer text-white">
                           Филиал Дагбитская
                        </li>
                     </ul>
                  </div>
               ...
               <div className="w-full rounded-3xl overflow-hidden">
                  <iframe
                     className={`w-full min-h-[750px] max-lg:min-h-[500px]  max-sm:min-h-[400px] ${
                        map ? "block" : "hidden"
                     }`}
